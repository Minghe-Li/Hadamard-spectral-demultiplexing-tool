...
folderpath1 = '\\SimpsonNAS2\Data\SashaRazumtcev\UVF-PTIR\10-26-21 Griseofulvin spectrum attempt 3\Hadamard rawdata';
...
for numberofrawdata = 1:length(theFiles)
    baseFileName = ['Raw_had' num2str(numberofrawdata) '_45us_1kHz_0.98gain_GI.mat'];
